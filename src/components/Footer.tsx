const Footer = () => {
  return (
    <footer className="bg-white h-[18rem] flex justify-center items-center p-8 dark:bg-black">
      <div className="container mx-auto grid grid nbv-cols-3 gap-4">
        <div className="text-left">
          <h1 className="text-black text-2xl font-bold dark:text-white">Gabriel Zimmermann</h1>
          <p className="text-yellow-500 text-base">Reliable, efficient, and always ready for new challenges.</p>
        </div>

        <div className="text-center">
          <h1 className="text-black text-sm mb-4 dark:text-white">gabriel.zimmermann4@icloud.com</h1>
        ...
        <div className="text-right">
          <h1 className="text-black text-sm dark:text-white">Phone: +41 76 302 29 12</h1>
        </div>
      </div>
    </footer>
  );
